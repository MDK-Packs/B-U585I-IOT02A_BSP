...
/**
  * @brief  Interrupt handler for rising edge on NOTIFY pin
  * @param  None
  * @retval None
  */
void MX_WIFI_NOTIFY_ISR(void)
{
    mxchip_WIFI_ISR(MX_WIFI_SPI_IRQ_PIN);
}

/**
  * @brief  Interrupt handler for rising edge on FLOW pin
  * @param  None
  * @retval None
  */
void MX_WIFI_FLOW_ISR(void)
{
    mxchip_WIFI_ISR(MX_WIFI_SPI_FLOW_PIN);
}
